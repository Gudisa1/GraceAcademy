...
const Course = () => {
  return (
    <div className="bg-primary mb-12" id="courses">
      <h1 className="text-center text-4xl text-white font-bold mt-12 py-12 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 mx-20">
        ...
        <div className="bg-white rounded-lg shadow-xl p-6 text-center t">
        ...
        <div className="bg-white rounded-lg shadow-xl text-center p-6">
          <h2 className="text-2xl font-semibold text-indigo-500">Web Design</h2>
          <figure className="flex justify-center mt-4 mb-4">
            <img
        ...
        {/* Course 6: DevOps */}
        <div className="bg-white rounded-lg text-center shadow-xl p-6">
          <h2 className="text-2xl font-semibold text-indigo-500">DevOps</h2>
          <figure className="flex justify-center mt-4 mb-4">
            <img
